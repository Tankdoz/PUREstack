...
# These are instructions to deploy PUREstack on a new host with Ubuntu 24.04 or later or Debian 13 or later
...
WEBPASSWORD=your_secure_password_here      # Change this to your desired Pi-hole web interface password
...
#         This describes the official way to instal Docker, 
#         you can skip if already installed or use the easy method:
...
# ++++++++++++++++++++++++++++++++++++++++++++++++++++++
# ---------------------------------------------------------------------
# 3 a. Pi-hole volume directories and permissions
# ---------------------------------------------------------------------
...
# ---------------------------------------------------------------------
# 3 b. Unbound volume directories and permissions
# ---------------------------------------------------------------------
    # The klutchel image is distroless --> contains only the necessary binaries and libraries to run Unbound, no shell or package manager
...
cp /path/to/your/unbound.conf ${DOCKERPROJECTS}${STACKSDIR}${PUREDIR}/volumes/unbound/unbound.conf
cp /path/to/your/unbound.conf.d/* ${DOCKERPROJECTS}${STACKSDIR}${PUREDIR}/volumes/unbound/unbound.conf.d/
...
# ---------------------------------------------------------------------
# 3 c. Redis volume directories and permissions
# ---------------------------------------------------------------------
...
# ---------------------------------------------------------------------
# 3 d. Unbound-exporter directories and permissions
# ---------------------------------------------------------------------
...
cp /path/to/your/Dockerfile.unbound-exporter ${DOCKERPROJECTS}${STACKSDIR}${PUREDIR}/exporter/Dockerfile
...
wget https://raw.githubusercontent.com/yourusername/dockerprojects/main/stacks/pure/compose.yaml
